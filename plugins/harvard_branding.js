    ...
    return (
        <div class="WithPlugins(WorkspaceControlPanel)-branding-2">
            <p class="MuiTypography-root MuiTypography-body1 MuiTypography-alignCenter">
                <a class="MuiButtonBase-root MuiIconButton-root" tabindex="0" aria-disabled="false" href="https://digitalcollections.library.harvard.edu/" target="_blank" rel="noopener">
